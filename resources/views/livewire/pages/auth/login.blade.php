    ...
    <div class="w-full max-w-[480px]">
        <div class="bg-white p-8 sm:p-12 rounded-[2rem] border border-slate-200 shadow-2xl shadow-slate-200/60 relative overflow-hidden">
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight mb-3">خوش‌آمدید!</h1>
                <p class="text-base text-slate-600 leading-relaxed">
                    برای دسترسی به پنل کاربری، لطفاً وارد شوید.
                </p>
            </div>

            <form wire:submit="login" class="space-y-7" action="{{ route('login') }}" method="POST">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center cursor-pointer group select-none">
                        <div class="relative flex items-center">
                            <input wire:model.blur="form.remember" type="checkbox"
                                   class="peer size-5 rounded border-2 border-slate-300 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-2 transition-all checked:bg-indigo-600 checked:border-indigo-600">
                        </div>
                        <span class="mr-3 text-sm font-medium text-slate-600 group-hover:text-slate-900 transition-colors">مرا به خاطر بسپار</span>
                    </label>

                    <a href="#" class="text-sm font-bold text-indigo-600 hover:text-indigo-700 hover:underline underline-offset-4 transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded">
                        فراموشی رمز عبور؟
                    </a>
                </div>
                ...
                <button wire:loading.attr="disabled" wire:target="login" type="submit"
                    ...
                    <div wire:loading.flex wire:target="login" class="flex items-center gap-3">
            ...
            <div class="mt-10 pt-6 border-t border-slate-100 text-center">
                <p class="text-slate-600 text-sm font-medium">
                    ...
                    <a href="{{ route("register") }}" wire:navigate class="inline-block font-bold text-indigo-600 hover:text-indigo-700 hover:underline underline-offset-4 transition-all mr-1 focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded px-1">
                        ثبت‌نام کنید
                    </a>
                </p>
            </div>
