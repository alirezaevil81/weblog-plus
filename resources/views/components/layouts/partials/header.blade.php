                    ...
                    <div class="relative hidden md:block group">
                        ...
                        <div class="absolute top-full left-0 w-56 bg-white rounded-xl shadow-lg ring-1 ring-slate-900/5 origin-top-left
                            ...
                            <div class="p-1" role="none">
                                ...
                                <!-- Menu Items -->
                                <a href="{{ route("users.show", auth()->user()->name) }}" class="flex items-center w-full px-3 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900 rounded-md" role="menuitem">
