        ...
        <div class="reveal bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
            ...
            <ul class="space-y-5">
                <li class="flex items-start space-x-2 group">
                    ...
                    <div><a href="#" class="font-semibold text-slate-800 group-hover:text-indigo-600 transition-colors leading-tight">چرا Tailwind CSS انتخاب بهتری است؟</a></div>
                </li>
                <li class="flex items-start space-x-2 group">
                    <span class="text-2xl font-bold text-slate-300 group-hover:text-indigo-500 transition-colors">۲</span>
                    <div><a href="#" class="font-semibold text-slate-800 group-hover:text-indigo-600 transition-colors leading-tight">مفاهیم پایه JavaScript در سال ۲۰۲۵</a></div>
                </li>
            </ul>
        </div>
        <!-- Newsletter -->
